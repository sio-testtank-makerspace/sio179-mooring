...
const unsigned long TIMEOUT_SEAPHOX_MS = 60000; // Max wait time for SeapHOx response (5 sec)
...
void loop() {
  ...
  ***/
  case PUBLISH_STATE: {
    ...
    //Note the lack of a timeout condition for acquiring SeapHOx data 3-14-19 Aidan Lucas 
